...
{
    public class frmStackedChartRenderer:System.Windows.Forms.UserControl,IEditItem,IRendererUI
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmStackedChartRenderer));
            ...
            // 
            // frmStackedChartRenderer
            // 
            this.Controls.Add(this.panelEx1);
            this.Name = "frmStackedChartRenderer";
        ...
        public frmStackedChartRenderer()
        {
            InitializeComponent();
        ...
        public void InitRendererObject(List<FieldInfo> pFields, IFeatureRenderer pRenderer, esriSymbologyStyleClass _SymbologyStyleClass)
        {
            ...
            if (!(pRenderer is IChartRenderer))//判断是否是图表渲染
                return;
            IChartRenderer pChartRenderer = pRenderer as IChartRenderer;
            if (pChartRenderer.ColorScheme != "")//颜色方案
                cmbColorRamp.Text = pChartRenderer.ColorScheme;

            if (pChartRenderer.BaseSymbol != null)//背景
        ...
        public IFeatureRenderer Renderer
        {
            get
            {
                ...
                pChartRenderer.ColorScheme = cmbColorRamp.Text;//色带名称
                if (labelPreviewBack.Tag != null)//背景符号
                    pChartRenderer.BaseSymbol = labelPreviewBack.Tag as ISymbol;
                if (chkIsUnOverlap.Checked)//是否覆盖
                ...
                ISymbolArray pSymbolArray = new StackedChartSymbolClass();//图表符号
                ...
                //IChartSymbol pMS = pSymbolArray as IChartSymbol;
                //if(sizeInput.Value>0)
                //    pMS.MaxValue= sizeInput.Value;//大小
                IMarkerSymbol pMS = pSymbolArray as IMarkerSymbol;
                if (sizeInput.Value > 0)
                    pMS.Size = sizeInput.Value;//大小
        ...
        private void listAddField_SelectedIndexChanged(object sender, EventArgs e)
        {
            RefreshColorRamp();
        }
