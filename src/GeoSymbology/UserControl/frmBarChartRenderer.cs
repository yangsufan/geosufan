...
{
    public class frmBarChartRenderer: System.Windows.Forms.UserControl, IEditItem, IRendererUI
    {
        ...
        public IFeatureRenderer Renderer
        {
            get
            {
                ...
                ISymbolArray pSymbolArray = new BarChartSymbolClass();//图表符号
                ...
                IBarChartSymbol pBCS = pSymbolArray as IBarChartSymbol;
                pBCS.Width = 10;
                pBCS.Spacing = 0;
