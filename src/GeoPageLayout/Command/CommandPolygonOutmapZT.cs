...
namespace GeoPageLayout
{
    ...
    [ProgId("GeoPageLayout.CommandPolygonOutmapZT")]
    public sealed class CommandPolygonOutmapZT : BaseTool
    {
        ...
        public CommandPolygonOutmapZT()
        {
            ...
            base.m_name = "CommandPolygonOutmapZT";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
            try
            {
                //
