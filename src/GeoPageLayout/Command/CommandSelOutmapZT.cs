...
namespace GeoPageLayout
{
    ...
    [ProgId("GeoPageLayout.CommandSelOutmapZT")]
    public sealed class CommandSelOutmapZT : BaseCommand
    {
        ...
        public CommandSelOutmapZT()
        {
            ...
            base.m_name = "GeoPageLayout_CommandSelOutmapZT";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
