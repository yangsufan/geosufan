...
namespace GeoPageLayout
{
    ...
    [ProgId("GeoPageLayout.CommandRectangleOutmapZT")]
    public sealed class CommandRectangleOutmapZT : BaseTool
    {
        ...
        public CommandRectangleOutmapZT()
        {
            //
            ...
            base.m_name = "GeoPageLayout_CommandRectangleOutmapZT";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
            //pExtent = pEnv;
            try
            {
                //
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            ...
            frm = new FrmPageLayout(m_hookHelper.FocusMap, pGeometry, true);
