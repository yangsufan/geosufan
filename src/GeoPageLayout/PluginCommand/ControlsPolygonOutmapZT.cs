...
namespace GeoPageLayout
{
    ...
    /// 说明：多边形范围专题图
    /// </summary>
    public class ControlsPolygonOutmapZT : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
       public Plugin.Application.IAppFormRef m_frmhook;
       private ICommand _cmd = null;
       public ControlsPolygonOutmapZT()
        {
            base._Name = "GeoPageLayout.ControlsPolygonOutmapZT";
            base._Caption = "多边形范围专题图";
            base._Tooltip = "多边形范围专题图";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "多边形范围专题图";
        }
       public override bool Enabled
       {
        ...
        public override void OnClick()
        {
            ...
            try
            {
                if (this.WriteLog)
                {
                    Plugin.LogTable.Writelog("多边形范围专题图", m_Hook.tipRichBox);
                }
                _cmd = new CommandPolygonOutmapZT();
                CommandPolygonOutmapZT tempCommand = _cmd as CommandPolygonOutmapZT;
