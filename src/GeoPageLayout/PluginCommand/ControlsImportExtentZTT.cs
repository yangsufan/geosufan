...
{
    public class ControlsImportExtentZTT : Plugin.Interface.CommandRefBase
    {
       ...
       private FrmPageLayout fmPageLayout = null;//制图界面
        ...
        public ControlsImportExtentZTT()
        {
            base._Name = "GeoPageLayout.ControlsImportExtentZTT";
            base._Caption = "导入范围专题图";
            base._Tooltip = "导入范围专题图";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "导入范围专题图";
        ...
        public override void OnClick()
        {
            ...
            try
            {
                ...
                if (this.WriteLog)
                {
                    Plugin.LogTable.Writelog("导入范围专题图,范围文件路径为:" + dlg.FileName);
                }
                ...
                fmPageLayout = new FrmPageLayout(pMap, pGon as IGeometry, true);
