...
namespace GeoPageLayout
{
    ...
    /// </summary>
    public class ControlsBlockOutMapDLFB : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsBlockOutMapDLFB()
        {
            base._Name = "GeoPageLayout.ControlsBlockOutMapDLFB";
            base._Caption = "导入范围地类分布图";
            base._Tooltip = "导入范围地类分布图";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "导入范围地类分布图";
        }
