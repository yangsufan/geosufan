...
namespace GeoPageLayout
{
    ...
    /// </summary>
    public class ControlsBlockOutMapZTGNQ : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsBlockOutMapZTGNQ()
        {
            base._Name = "GeoPageLayout.ControlsBlockOutMapZTGNQ";
            base._Caption = "导入范围林地主体功能区分布图";
            base._Tooltip = "导入范围林地主体功能区分布图";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "导入范围林地主体功能区分布图";
        }
