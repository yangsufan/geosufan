   ...
   public class ControlsEnterIntoDataManageFramSys: Plugin.Interface.CommandRefBase
    {
       ...
       //构造函数
        ...
        {
            base._Name = "GeoDBConfigFrame.ControlsEnterIntoDataManageFramSys";
            base._Caption = "中心管理";
            base._Tooltip = "中心管理";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "进入数据中心管理子系统";
        }
       ...
       //按钮的click事件
        public override void OnClick()
        {
            ...
            pSysName = "GeoDataManagerFrame.ControlCenterFrame";
            //根据Name获得子系统的caption
            ...
            if (ModFrameData.v_SysLog != null)
            {
                ...
                ModFrameData.v_SysLog.Write("进入数据库中心管理子系统", Pra, DateTime.Now);
            } 
        }
