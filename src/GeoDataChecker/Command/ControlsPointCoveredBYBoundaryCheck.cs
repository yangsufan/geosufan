...
{
    public class ControlsPointCoveredBYBoundaryCheck:Plugin.Interface.CommandRefBase
    {
       private Plugin.Application.IAppGISRef _AppHk;

        public ControlsPointCoveredBYBoundaryCheck()
        {
            base._Name = "GeoDataChecker.ControlsPointCoveredBYBoundaryCheck";
            base._Caption = "点搭面检查";
            base._Tooltip = "检查点是否在面得边界上";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "点搭面检查";
        ...
        public override void OnClick()
        {
            ...
            //执行点搭面检查
            FrmMathematicsCheck mFrmMathematicsCheck = new FrmMathematicsCheck(_AppHk, enumErrorType.点搭面检查);
            ...
            //    dataCheckCls.OrdinaryTopoCheck( pFeaDataset, oriFeaClsName,desFeaClsName,esriTopologyRuleType.esriTRTPointCoveredByAreaBoundary, out eError);
            //    if (eError != null)
            //    {
            ...
            //SysCommon.Error.ErrorHandle.ShowFrmErrorHandle("提示", "点搭面检查完成!");
        }
