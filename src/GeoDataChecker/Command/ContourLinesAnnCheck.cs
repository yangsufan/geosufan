...
{
    public class ContourLinesAnnCheck:Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGISRef _AppHk;

        public ContourLinesAnnCheck()
        {
            base._Name = "GeoDataChecker.ContourLinesAnnCheck";
            base._Caption = "等高线注记检查";
            base._Tooltip = "检查等高线的高程注记和等高线的elevation值是否一致";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "等高线注记检查";
        }
        ...
        {
            //执行等高线注记检查
            //FrmMathematicsCheck mFrmMathematicsCheck = new FrmMathematicsCheck(_AppHk, enumErrorType.等高线注记一致性);
        ...
        private void PointAnnoCheck(DataCheckClass pDataCheckClass, List<IFeatureClass> LstFeaClass, DataTable pTable, string codeName, double radiu, long precision, out Exception eError)
        {
            ...
            for (int i = 0; i < pTable.Rows.Count; i++)
            {
                ...
                //改变树图运行状态
                pDataCheckClass.ChangeTreeSelectNode(pNode, "完成图层" + oriFeaClsName + "等高线注记一致性检查！", false);
            }
        }
    }
}
