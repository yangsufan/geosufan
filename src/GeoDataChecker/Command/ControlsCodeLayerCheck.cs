...
namespace GeoDataChecker
{
    ...
    /// 代码图层检查
    /// </summary>
   public  class ControlsCodeLayerCheck: Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGISRef _AppHk;
        private DataTable _ResultTable;
        private clsCodeCheckProccess _CodeLayerErrorPro;

       public ControlsCodeLayerCheck()
        {
            base._Name = "GeoDataChecker.ControlsCodeLayerCheck";
        ...
        public override void OnClick()
        {
            ...
            //_CodeLayerErrorPro = new clsCodeCheckProccess();
            ClsCodeCheck CodeLayerErrerCheck = new ClsCodeCheck(_AppHk, path, LstFeaLayer);
            CodeLayerErrerCheck.ErrDbCon = pSysLog.DbConn;
            CodeLayerErrerCheck.ErrTableName = "错误日志";

            //CodeLayerErrerCheck.FindErr += new GOGISErrorChecker.EventHandle(CodeLayerErrerCheck_FindErr);
            CodeLayerErrerCheck.ExcuteLayerCheck();

            //_CodeLayerErrorPro.Dispose();
       ...
       private void CodeLayerErrerCheck_FindErr(object sender, ErrorEventArgs ErrorArg)
        {
            //若错误结果不为空
            if (ErrorArg != null)
            {
                ...
                {
                    _CodeLayerErrorPro.LogErr(sender, ErrorArg);
                }
            }
        }
