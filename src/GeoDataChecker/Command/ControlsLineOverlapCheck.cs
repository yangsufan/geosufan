...
{
    public class ControlsLineOverlapCheck:Plugin.Interface.CommandRefBase
    {

       private Plugin.Application.IAppGISRef _AppHk;

        public ControlsLineOverlapCheck()
        {
            base._Name = "GeoDataChecker.ControlsLineOverlapCheck";
            base._Caption = "同层线重叠检查";
            base._Tooltip = "检查在同一层要素类中（同一层之间的关系）线与线是否相互重叠";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "同层线重叠检查";
        }
        ...
        public override void OnClick()
        {
            ...
            //执行同层线重叠检查
            FrmMathematicsCheck mFrmMathematicsCheck = new FrmMathematicsCheck(_AppHk, enumErrorType.同层线重叠检查);
            ...
            //    dataCheckCls.OrdinaryTopoCheck( pFeaDataset, esriGeometryType.esriGeometryPolyline, esriTopologyRuleType.esriTRTLineNoOverlap, out eError);
            //    if (eError != null)
            //    {
            ...
            //SysCommon.Error.ErrorHandle.ShowFrmErrorHandle("提示", "同层线重叠检查完成!");
        }
