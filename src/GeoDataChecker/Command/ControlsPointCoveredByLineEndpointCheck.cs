   ...
   public class ControlsPointCoveredByLineEndpointCheck:Plugin.Interface.CommandRefBase
    {
       private Plugin.Application.IAppGISRef _AppHk;
        ...
        public ControlsPointCoveredByLineEndpointCheck()
        {
            ...
            base._Caption = "点位于线端点检查";
            base._Tooltip = "检查点是否位于线的端点上";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "点位于线端点检查";
        }
        ...
        public override void OnClick()
        {
            ...
            //执行点位于线端点检查
            FrmMathematicsCheck mFrmMathematicsCheck = new FrmMathematicsCheck(_AppHk, enumErrorType.点位于线端点检查);
            ...
            //SysCommon.Error.ErrorHandle.ShowFrmErrorHandle("提示", "点位于线端点检查完成!");
        }
