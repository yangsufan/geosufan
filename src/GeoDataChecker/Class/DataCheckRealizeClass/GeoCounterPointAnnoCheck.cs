...
namespace GeoDataChecker
{
    ...
    /// 高程点注记一致性检查
    /// </summary>
    public class GeoCounterPointAnnoCheck : IDataCheckRealize
    {
        ...
        public void OnDataCheck()
        {
            ...
            //    //高程点注记检查，参数ID为30
            //    DataTable mTable = TopologyCheckClass.GetParaValueTable(featureDataset, pSysTable, 30, out eError);
            //    if (eError != null)
            //    {
            //        //SysCommon.Error.ErrorHandle.ShowFrmErrorHandle("提示", eError.Message);
            //        return;
            ...
            //    }
            //    //高程点注记检查搜索半径,参数ID为33
            //    string paraValue2 = TopologyCheckClass.GetParaValue(pSysTable, 33, out eError);
            //    if (eError != null)
            //    {
            //        eError=new Exception("读取数据减配置表失败。" + eError.Message);
            //        return;
            ...
            //    //高程点注记检查精度控制，参数ID为36
            //    paraValue2 = TopologyCheckClass.GetParaValue(pSysTable, 36, out eError);
            //    if (eError != null)
            //    {
            //        eError = new Exception("读取数据减配置表失败。" + eError.Message);
            //        return;
            ...
            //    //执行高程点注记检查
            //    PointAnnoCheck(Hook, featureDataset, mTable, codeName, serchRadiu2, precision2, out eError);
            //    if (eError != null)
            //    {
            //        eError = new Exception("高程点注记检查失败。" + eError.Message);
            //        return;
            //    }
            //}
            #endregion
