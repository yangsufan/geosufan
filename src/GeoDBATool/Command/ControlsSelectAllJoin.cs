...
{
    class ControlsSelectAllJoin : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGISRef m_Hook;
        private string DataGridNo = string.Empty;
        public ControlsSelectAllJoin()
        {
            base._Name = "GeoDBATool.ControlsSelectAllJoin";
            base._Caption = "全部选择已选择";
            base._Tooltip = "全部选择";
            base._Visible = true;
            base._Enabled = true;
            base._Message = "全部选择";
        ...
        public override void OnClick()
        {
            ...
            for (int i = 0; i < GetDataGrid.Rows.Count; i++)
            {
                ...
                if (GetDataGrid.Rows[i].Cells[GetDataGrid.ColumnCount - 1].Value.ToString().Trim() == "已接边")//判断如果是已接边则选中 20110829 xisheng
                {
