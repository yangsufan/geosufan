...
{
     /// <summary>
    /// 栅格数据入库 cyf 20110609 add:按文件夹进行栅格数据入库
    /// </summary>
    public class ControlsRasterBatchImport: Plugin.Interface.CommandRefBase
    {
        ...
        //初始化按钮信息
        public ControlsRasterBatchImport()
        {
            base._Name = "GeoDBATool.ControlsRasterBatchImport";
            base._Caption = "栅格批量入库";
            base._Tooltip = "栅格数据入库，按文件夹";
            base._Visible = true;
            base._Enabled = true;
            base._Message = "栅格批量入库";
