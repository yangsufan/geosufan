...
{
    public class ControlsResMapIdentifyTool : Plugin.Interface.ToolRefBase
    {
        ...
        public ControlsResMapIdentifyTool()
        {
            base._Name = "GeoUtilities.ControlsResMapIdentifyTool";
            base._Caption = "属性查询";
            base._Tooltip = "属性查询";
            base._Checked = false;
            base._Visible = true;
    ...
    public class ControlsResMapIdentify : BaseTool
    {
        ...
        //类的方法
        public ControlsResMapIdentify(Form mainFrm)
        {
            m_mainFrm = mainFrm;
