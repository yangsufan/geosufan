...
namespace GeoDBIntegration
{
    ...
    public class ControlsRangeDataAdd: Plugin.Interface.CommandRefBase
    {
        ...
        {
            base._Name = "GeoDBIntegration.ControlsRangeDataAdd";
        ...
        public override bool Enabled
        {
            get
            {
                ...
                if (ModuleData.v_AppDBIntegra.ProjectTree.SelectedNode == null) return false;
                if (ModuleData.v_AppDBIntegra.ProjectTree.SelectedNode.Tag == null) return false;
                XmlElement DBInfoEle = ModuleData.v_AppDBIntegra.ProjectTree.SelectedNode.Tag as XmlElement;
