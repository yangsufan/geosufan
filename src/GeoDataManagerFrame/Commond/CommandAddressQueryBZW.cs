...
{
    public class CommandAddressQueryBZW : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public CommandAddressQueryBZW()
        {
            base._Name = "GeoDataManagerFrame.CommandAddressQueryBZW";
            base._Caption = "地物要素查询";
            base._Tooltip = "地物要素查询";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "地物要素查询";
        }
        ...
        public override void OnClick()
        {
            ...
            if (getDMDZLayer(m_Hook.ArcGisMapControl.Map, "标志物地名") == null)
            {
                MessageBox.Show("当前没有加载标志物地名图层！", "提示", MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                if (this.WriteLog)
                {
                    Plugin.LogTable.Writelog(Caption + " 提示‘当前没有加载标志物地名图层！’", m_Hook.tipRichBox);
                }
                return;
