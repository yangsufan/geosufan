...
{
   public class CommandLengend : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        FrmLegend fmEE = null;
        public CommandLengend()
        {
            base._Name = "GeoDataManagerFrame.CommandLengend";
            base._Caption = "图例";
            base._Tooltip = "图例";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            if (fmEE==null)//第一次打开鹰眼  第二次关闭鹰眼
            {
                ...
                try
                {
                    ...
                    fmEE = new FrmLegend(m_Hook.ArcGisMapControl, this, Plugin.ModuleCommon.TmpWorkSpace);
                    ...
                    fmEE.FormClosed += new FormClosedEventHandler(FrmLengend_FormClosed);
                    if (this.WriteLog)
                    {
       ...
       //added by chulili 20110729 对关闭事件的处理
        private void FrmLengend_FormClosed(object sender, FormClosedEventArgs e)
        {
            fmEE = null;
            this._Checked = false;
        }
