...
{
    public class DefinitionMapShow : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        //ICommand m_pCommand = null;

        public DefinitionMapShow()
        {
            base._Name = "GeoDataManagerFrame.DefinitionMapShow";
            base._Caption = "自定义显示";
            base._Tooltip = "自定义显示";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
           ...
           // (m_pCommand as GeoProperties.LayerPropertiesTool).CurLayer = _AppHk.MapControl.CustomProperty as ILayer;
            ...
            FrmDefinitionQuery newfrm = new FrmDefinitionQuery(_AppHk.MapControl);
            newfrm.ShowDialog();
           // m_pCommand.OnClick();
        }
