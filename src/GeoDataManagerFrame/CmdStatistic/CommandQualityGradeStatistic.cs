...
{
    public class CommandQualityGradeStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        public CommandQualityGradeStatistic()
        {
            base._Name = "GeoDataManagerFrame.CommandQualityGradeStatistic";
            base._Caption = "质量等级统计";
            base._Tooltip = "质量等级统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "质量等级统计";
        }
