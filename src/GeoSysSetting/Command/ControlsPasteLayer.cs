...
{
    public class ControlsPasteLayer : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsPasteLayer()
        {
            base._Name = "GeoSysSetting.ControlsPasteLayer";
            base._Caption = "粘贴图层";
            base._Tooltip = "粘贴图层";
            base._Checked = false;
            base._Visible = true;
            ...
            get
            {
                ...
                if (_hook.MainForm.Controls[0] is SubControl.UCDataSourceManger)
                {
                    ...
                    if (pUCdatasource != null)
                    {
                        ...
                        {
                            bool bRes = pUCdatasource.CanPasteLayer();
                            if (bRes)
                            {
                                return true;
                            }
