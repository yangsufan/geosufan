...
{
    public class ControlsAddWMSserviceLyr : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsAddWMSserviceLyr()
        {
            base._Name = "GeoSysSetting.ControlsAddWMSserviceLyr";
            base._Caption = "添加WMS服务图层";
            base._Tooltip = "添加WMS服务图层";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "添加WMS服务图层";
        }
        ...
        public override void OnClick()
        {
            ...
            pUCdatasource.AddWMSserviceLayer();
