...
{
    public class ControlsAddDataSet : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsAddDataSet()
        {
            base._Name = "GeoSysSetting.ControlsAddDataSet";
            base._Caption = "添加数据集";
            base._Tooltip = "添加数据集";
            base._Checked = false;
            base._Visible = true;
