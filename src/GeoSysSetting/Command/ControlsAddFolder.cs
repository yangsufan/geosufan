...
{
    public class ControlsAddFolder : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsAddFolder()
        {
            base._Name = "GeoSysSetting.ControlsAddFolder";
            base._Caption = "添加专题";
            base._Tooltip = "添加专题";
            base._Checked = false;
            base._Visible = true;
            ...
            get
            {
                ...
                if (_hook.MainForm.Controls[0] is SubControl.UCDataSourceManger)
                {
                    ...
                    if (pUCdatasource != null)
                    {
                        ...
                        if (strtag.Equals("DIR") || strtag.Equals("Root"))
                            return true;
                    }
                }
                return false;
