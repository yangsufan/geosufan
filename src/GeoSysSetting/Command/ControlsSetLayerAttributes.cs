...
{
    public class ControlsSetLayerAttributes : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsSetLayerAttributes()
        {
            base._Name = "GeoSysSetting.ControlsSetLayerAttributes";
            base._Caption = "批量设置属性";
            base._Tooltip = "批量设置图层属性";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "批量设置图层属性";
        }
