...
{
    public class ControlsSetDBSource : Plugin.Interface.CommandRefBase
    {
        private UserControl ucCtl = null;
        private Plugin.Application.IAppFormRef m_Hook;
        private Plugin.Application.IAppFormRef _hook;

        public ControlsSetDBSource()
        {
            base._Name = "GeoSysSetting.ControlsSetDBSource";
            base._Caption = "设置数据源";
            base._Tooltip = "设置数据源";
            base._Checked = false;
            base._Visible = true;
