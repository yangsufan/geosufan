...
{
    public class ControlsMapZoomOutFixedCommand : Plugin.Interface.CommandRefBase
    {
        ...
        public ControlsMapZoomOutFixedCommand()
        {
            base._Name = "GeoDataCenterFunLib.ControlsMapZoomOutFixedCommand";
            base._Caption = "中心缩小";
            base._Tooltip = "中心缩小";
            base._Checked = false;
            base._Visible = true;
