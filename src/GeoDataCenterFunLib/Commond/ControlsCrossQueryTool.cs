...
{
   public class ControlsCrossQueryTool : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsCrossQueryTool()
        {
            base._Name = "GeoDataCenterFunLib.ControlsCrossQueryTool";
            base._Caption = "穿越查询";
            base._Tooltip = "穿越查询";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            try
            {
                frmQuerySet fmQS = new frmQuerySet(m_Hook.ArcGisMapControl.Map, queryType.Cross);
                ...
                fmQuery.FillData(fmQS.lstQueryedLayer, fmQS.GeometryBag, queryType.Cross);
                pgss.Close();
                Application.DoEvents();
                if (this.WriteLog)
                {
