...
{
   public class ControlsIntersectQueryTool : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsIntersectQueryTool()
        {
            base._Name = "GeoDataCenterFunLib.ControlsIntersectQueryTool";
            base._Caption = "相交查询";
            base._Tooltip = "相交查询";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            try
            {
                frmQuerySet fmQS = new frmQuerySet(m_Hook.ArcGisMapControl.Map, queryType.Intersect );
                ...
                fmQuery.FillData(fmQS.lstQueryedLayer, fmQS.GeometryBag, queryType.Intersect );
                pgss.Close();
                Application.DoEvents();
                if (this.WriteLog)
                {
