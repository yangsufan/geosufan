...
{
    public class ControlsMapZoomInTool:Plugin.Interface.ToolRefBase
    {
        ...
        public ControlsMapZoomInTool()
        {
            base._Name="GeoDataCenterFunLib.ControlsMapZoomInTool";
            base._Caption = "放大";
            base._Tooltip="放大";
            base._Checked = false;
            base._Visible = true;
            ...
            base._Message = "单击或拉框进行放大";
            //base._Cursor = (int)esriControlsMousePointer.esriPointerPageZoomIn;
            //base._Image = "";
            //base._Category = "";
        }
