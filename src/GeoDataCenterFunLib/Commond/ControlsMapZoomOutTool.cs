...
{
    public class ControlsMapZoomOutTool : Plugin.Interface.ToolRefBase
    {
        ...
        public ControlsMapZoomOutTool()
        {
            base._Name = "GeoDataCenterFunLib.ControlsMapZoomOutTool";
            base._Caption = "缩小";
            base._Tooltip = "缩小";
            base._Checked = false;
            base._Visible = true;
            ...
            base._Message = "单击或拉框进行缩小";
            //base._Cursor = (int)esriControlsMousePointer.esriPointerPageZoomOut;
            //base._Image = "";
            //base._Category = "";
        }
