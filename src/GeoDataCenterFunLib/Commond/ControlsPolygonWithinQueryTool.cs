...
{
    public class ControlsPolygonWithinQueryTool : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsPolygonWithinQueryTool()
        {
            base._Name = "GeoDataCenterFunLib.ControlsPolygonWithinQueryTool";
            base._Caption = "落入查询";
            base._Tooltip = "落入查询";
            base._Checked = false;
            base._Visible = true;
