...
{
    public class CommandExportByAttribute : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandExportByAttribute()
        {
            base._Name = "GeoDataCenterFunLib.CommandExportByAttribute";
            base._Caption = "按属性提取";
            base._Tooltip = "按属性提取";
            base._Checked = false;
            base._Visible = true;
