...
{
    public class CommandEnvelopeExport : Plugin.Interface.CommandRefBase
    {
        ...
        public CommandEnvelopeExport()
        {
            base._Name = "GeoDataCenterFunLib.CommandEnvelopeExport";
            base._Caption = "矩形范围提取";
            base._Tooltip = "矩形范围提取";
            base._Checked = false;
            base._Visible = true;
            base._Enabled =false;
            base._Message = "矩形范围提取";

            m_pCommand = new GeoDataExport.Commands.ToolEvnelopeExport();
        }
        ...
        public override void OnClick()
        {
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog(base._Caption);//xisheng日志记录
            }
