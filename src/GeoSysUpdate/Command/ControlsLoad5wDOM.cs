...
{
    public class ControlsLoad5wDOM : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;

        public ControlsLoad5wDOM()
        {
            base._Name = "GeoSysUpdate.ControlsLoad5wDOM";
            base._Caption = "5万DOM";
            base._Tooltip = "5万DOM";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            string strSearch = "//LoadDataConfig/LoadItem[@ItemText='DOM']/NodeItem";
