...
{
    public class ControlsLoad927DEM : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        
        public ControlsLoad927DEM()
        {
            base._Name = "GeoSysUpdate.ControlsLoad927DEM";
            base._Caption = "927DEM";
            base._Tooltip = "927DEM";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "927DEM";
        }
        ...
        public override void OnClick()
        {
            ...
            string strSearch = "//LoadDataConfig/LoadItem[@ItemText='927DEM']/NodeItem";
