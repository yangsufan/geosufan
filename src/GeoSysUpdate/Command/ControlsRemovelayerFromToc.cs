...
{
    public class ControlsRemoveLayerFromToc : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        public ControlsRemoveLayerFromToc()
        {
            base._Name = "GeoSysUpdate.ControlsRemoveLayerFromToc";
            base._Caption = "移除图层";
        ...
        public override void OnClick()
        {
            ...
            try
            {
                GeoLayerTreeLib.LayerManager.UcDataLib pUC = (_AppHk as Plugin.Application.AppGidUpdate).LayerTree as GeoLayerTreeLib.LayerManager.UcDataLib;
                pUC.Removelayer(mLayer);
            }
            catch
            { }
