...
{
    public class ControlsLoad927DOM : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        
        public ControlsLoad927DOM()
        {
            base._Name = "GeoSysUpdate.ControlsLoad927DOM";
            base._Caption = "927DOM";
            base._Tooltip = "927DOM";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "927DOM";
        }
        ...
        public override void OnClick()
        {
            ...
            string strSearch = "//LoadDataConfig/LoadItem[@ItemText='927DOM']/NodeItem";
