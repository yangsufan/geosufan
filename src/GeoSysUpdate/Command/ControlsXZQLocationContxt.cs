...
{
    public class ControlsXZQLocationContxt : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        public ControlsXZQLocationContxt()
        {
            base._Name = "GeoSysUpdate.ControlsXZQLocationContxt";
            base._Caption = "行政区定位";
            base._Tooltip = "行政区定位";
            base._Checked = false;
            base._Visible = true;
