...
{
    public class ControlsMapSheetExportContxt : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        public ControlsMapSheetExportContxt()
        {
            base._Name = "GeoSysUpdate.ControlsMapSheetExportContxt";
            base._Caption = "行政区定位";
            base._Tooltip = "行政区定位";
            base._Checked = false;
            base._Visible = true;
