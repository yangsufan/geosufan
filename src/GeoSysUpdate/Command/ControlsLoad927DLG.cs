...
{
    public class ControlsLoad927DLG : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        private Plugin.Application.AppGidUpdate _hook;
        
        public ControlsLoad927DLG()
        {
            base._Name = "GeoSysUpdate.ControlsLoad927DLG";
            base._Caption = "927DLG";
            base._Tooltip = "927DLG";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "927DLG";
        }
        ...
        public override void OnClick()
        {
            ...
            string strSearch = "//LoadDataConfig/LoadItem[@ItemText='927DLG']/NodeItem";
