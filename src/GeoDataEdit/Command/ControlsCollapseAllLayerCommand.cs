...
namespace GeoDataEdit.Command
{
    ...
    /// </summary>
    [Guid("5c4a9bad-24ab-493b-9143-ede0acc01606")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("GeoDataEdit.Command.ControlsCollapseAllLayerCommand")]
    public sealed class ControlsCollapseAllLayerCommand : BaseCommand
    {
        ...
        public ControlsCollapseAllLayerCommand()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = ""; //localizable text
            base.m_caption = "ÕÛµþËùÓÐÍ¼²ã";  //localizable text 
            base.m_message = "ÕÛµþËùÓÐÍ¼²ã";  //localizable text
            base.m_toolTip = "";  //localizable text
            base.m_name = "CollapseAllLayer";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
