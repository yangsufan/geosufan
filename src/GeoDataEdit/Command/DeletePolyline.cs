...
{
    public class DeletePolyline : Plugin.Interface.ToolRefBase
    {
        ...
        {
            base._Name = "GeoDataEdit.DeletePolyline";
            base._Caption = "删除线";
            base._Tooltip = "删除线";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            if (tmpFeatureLayer == null || tmpFeatureLayer.FeatureClass.ShapeType != esriGeometryType.esriGeometryPolyline)
            {
                MessageBox.Show("请设置编辑图层为线图层！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            if (tmpFeature == null)
                return;
            if(tmpFeature.ShapeCopy.GeometryType!=esriGeometryType.esriGeometryPolyline)
            {
                MessageBox.Show("请选择线要素！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            if (MessageBox.Show("是否删除选择的线！", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) != DialogResult.Yes)
                return;
