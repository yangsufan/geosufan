...
namespace GeoDataEdit.Command
{
    ...
    /// </summary>
    [Guid("4a00e028-4f47-4af8-a094-d0b4725f59a2")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("GeoDataEdit.Command.ControlsOpenAllLayerCommand")]
    public sealed class ControlsOpenAllLayerCommand : BaseCommand
    {
        ...
        public ControlsOpenAllLayerCommand()
        {
            //
            ...
            base.m_name = "OpenAllLayer";   //unique id, non-localizable (e.g. "MyCategory_MyCommand")
