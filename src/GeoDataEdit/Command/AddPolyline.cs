...
{
    public class AddPolyline : Plugin.Interface.ToolRefBase
    {
        ...
        public override void OnCreate(Plugin.Application.IApplicationRef hook)
        {
            ...
            _cmd = new ControlsMapAddPolyline(pAppForm.MainForm);
    ...
    public class ControlsMapAddPolyline : BaseTool
    {
        ...
        //类的方法
        public ControlsMapAddPolyline(Form mainFrm)
        {
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            ...
            if (pGeometry.GeometryType != esriGeometryType.esriGeometryPolyline) return;
