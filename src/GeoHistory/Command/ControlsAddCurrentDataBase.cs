...
{
    public class ControlsAddCurrentDataBase : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGISRef _AppHk;
        public ControlsAddCurrentDataBase()
        {
            base._Name = "GeoHistory.ControlsAddCurrentDataBase";
            base._Caption = "加载现势库数据";
            base._Tooltip = "加载现势库数据";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = true;
            base._Message = "加载服务器上现势库数据";
            //base._Image = "";
            //base._Category = "";
        }
