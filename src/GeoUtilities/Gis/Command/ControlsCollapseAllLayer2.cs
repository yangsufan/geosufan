...
namespace GeoUtilities
{
    ...
    /// 右键菜单折叠图层   chenyafei
    /// </summary>
    public class ControlsCollapseAllLayer2 : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppFormRef myHook;
        public ControlsCollapseAllLayer2()
        {

            base._Name = "GeoUtilities.ControlsCollapseAllLayer2";
