...
{
    public class ControlsZoomToVisibleScale : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef _AppHk;
        public ControlsZoomToVisibleScale()
        {
            base._Name = "GeoUtilities.ControlsZoomToVisibleScale";
            base._Caption = "缩放到图层";
            base._Tooltip = "缩放到图层";
            base._Checked = false;
            base._Visible = true;
