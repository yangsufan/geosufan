...
namespace GeoUtilities
{
    ...
    /// 右键菜单折叠图层   chenyafei
    /// </summary>
    public class ControlsUnVisibleAllLayer2 : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef myHook;
        public ControlsUnVisibleAllLayer2()
        {

            base._Name = "GeoUtilities.ControlsUnVisibleAllLayer2";
