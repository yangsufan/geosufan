...
namespace GeoUtilities
{
    ...
    /// 右键菜单折叠图层   chenyafei
    /// </summary>
    public class ControlsUnVisibleAllLayer1 : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppArcGISRef myHook;
        public ControlsUnVisibleAllLayer1()
        {

            base._Name = "GeoUtilities.ControlsUnVisibleAllLayer1";
