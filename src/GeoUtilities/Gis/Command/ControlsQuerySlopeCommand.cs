...
//ZQ  20110808    add    坡度查询
namespace GeoUtilities
{
    public class ControlsQuerySlopeCommand : Plugin.Interface.CommandRefBase
    {

         private Plugin.Application.IAppGisUpdateRef m_Hook;
        private Plugin.Application.IAppFormRef m_frmhook;
        public ControlsQuerySlopeCommand()
        {
            base._Name = "GeoUtilities.ControlsQuerySlopeCommand";
            base._Caption = "坡度查询";
            base._Tooltip = "坡度查询";
            base._Checked = false;
            base._Visible = true;
