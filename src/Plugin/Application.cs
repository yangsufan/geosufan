...
namespace Plugin.Application
{
    ...
    //public class AppDBProject : IAppDBProjectRef, IAppFormRef
    //{
    //    private UserControl _MainUserControl;                         //控件UserControl
    //    private Control _StatusStrip;                                 // 状态栏
    //    private Control _ControlContainer;                             // 控件容器
    //    private XmlDocument _SystemXml;                                // 系统功能树图Xml节点
    //    private XmlDocument _DBMainXml;                                // 数据工程XML
    //    private Plugin.Parse.PluginCollection _ColParsePlugin;         // 系统插件集合
    //    private Dictionary<string, DevComponents.DotNetBar.ContextMenuBar> _DicContextMenu;           //右键菜单集合
    //    private string _ImageResPath;                                  // 图片资源路径
    //    private IMapDocument _MapDocument;                            //存储的文档对象
    ...
    //    private DevComponents.AdvTree.AdvTree _CaseDataTree;        // 业务树图
    //    private DevComponents.AdvTree.AdvTree _DBDataTree;          // 数据库配置树图
    ...
    //    public AppDBProject(Control ControlContainer, XmlDocument SystemXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _ControlContainer = ControlContainer;
    //        _SystemXml = SystemXml;
    ...
    //        #region 自定义状态栏
    //        DevComponents.DotNetBar.Bar statusBar = new DevComponents.DotNetBar.Bar();
    //        statusBar.Name = "DBProjectStatusBar";
    //        statusBar.TabStop = false;
    //        statusBar.Stretch = true;
    //        statusBar.Style = DevComponents.DotNetBar.eDotNetBarStyle.Office2007;
    //        statusBar.AccessibleRole = System.Windows.Forms.AccessibleRole.StatusBar;
    ...
    //        //操作提示内容
    //        DevComponents.DotNetBar.LabelItem aLabelItem = new DevComponents.DotNetBar.LabelItem();
    //        aLabelItem.Name = "DBProjectLabel";
    //        aLabelItem.Stretch = true;
    //        aLabelItem.PaddingLeft = 2;
    //        aLabelItem.PaddingRight = 2;
    //        aLabelItem.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
    ...
    //        progressBarItem.ChunkGradientAngle = 0F;
    //        progressBarItem.MenuVisibility = DevComponents.DotNetBar.eMenuVisibility.VisibleAlways;
    //        progressBarItem.Name = "DBProjectprogressBarItem";
    //        progressBarItem.RecentlyUsed = false;
    //        progressBarItem.Stretch = true;
    //        progressBarItem.Visible = false;
    ...
    //        //图上点坐标内容
    //        DevComponents.DotNetBar.LabelItem aCoorLabelItem = new DevComponents.DotNetBar.LabelItem();
    //        aCoorLabelItem.Name = "DBProjectCoorLabel";
    //        aCoorLabelItem.Stretch = true;
    //        aCoorLabelItem.PaddingLeft = 2;
    //        aCoorLabelItem.PaddingRight = 2;
    //        aCoorLabelItem.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
    ...
    //        //用户信息内容
    //        DevComponents.DotNetBar.LabelItem aUserInfoLabelItem = new DevComponents.DotNetBar.LabelItem();
    //        aUserInfoLabelItem.Name = "DBProjectUserInfoLabel";
    //        aUserInfoLabelItem.Stretch = true;
    //        aUserInfoLabelItem.PaddingLeft = 2;
    //        aUserInfoLabelItem.PaddingRight = 2;
    //        aUserInfoLabelItem.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));

    //        statusBar.Items.AddRange(new DevComponents.DotNetBar.BaseItem[] { aLabelItem, progressBarItem, RefScaleCmb, CurScaleCmb, CoorTxt, aUserInfoLabelItem });
    //        this.StatusBar = statusBar;
    //        #endregion
    //    }

    //    #region IAppDBProjectRef 成员
    //    public UserControl MainUserControl
    //    {
    //        get
    //        {
    ...
    //    public DevComponents.AdvTree.AdvTree CaseDataTree
    //    {
    //        get
    //        {
    //            return _CaseDataTree;
    //        }
    //        set
    //        {
    //            _CaseDataTree = value;
    ...
    //    public DevComponents.AdvTree.AdvTree DBDataTree
    //    {
    //        get
    //        {
    //            return _DBDataTree;
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                return statusBar.Items["DBProjectLabel"].Text;
    //            }
    //            catch
    //            {
    //                return string.Empty;
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                statusBar.Items["DBProjectLabel"].Text = value;
    //            }
    //            catch
    //            {
    //            }
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                return statusBar.Items["DBProjectprogressBarItem"] as DevComponents.DotNetBar.ProgressBarItem;
    //            }
    //            catch
    //            {
    //                return null;
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                statusBar.Items["DBProjectprogressBarItem"] = value;
    //            }
    //            catch
    //            {
    //            }
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                return statusBar.Items["DBProjectUserInfoLabel"].Text;
    //            }
    //            catch
    //            {
    //                return string.Empty;
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                statusBar.Items["DBProjectUserInfoLabel"].Text = value;
    //            }
    //            catch
    //            {
    //            }
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                return statusBar.Items["DBProjectCoorLabel"].Text;
    //            }
    //            catch
    //            {
    //                return string.Empty;
    ...
    //            {
    //                DevComponents.DotNetBar.Bar statusBar = this.StatusBar as DevComponents.DotNetBar.Bar;
    //                statusBar.Items["DBProjectCoorLabel"].Text = value;
    //            }
    //            catch
    //            {
    //            }
    ...
    //public class AppOracleSpatialRef : IAppOracleSpatialRef
    //{
    ...
    //    private Dictionary<string, DevComponents.DotNetBar.ContextMenuBar> _DicContextMenu;           //右键菜单集合
    //    private string _ImageResPath;                                  // 图片资源路径            
    //    private DevComponents.AdvTree.AdvTree _OraProjectTree;       // 工程信息树    
    //    private Thread _CurrentThread;                           //处理数据的进程(唯一)
    //    private XmlDocument _DBXmlDocument;                       //数据工程配置XML文件
    //    private User _user;                                          //连接的用户信息
    //    //cyf 20110602 add
    ...
    //    private XmlDocument _DataTreeXml;                              // 数据树图XML节点
    //    private XmlDocument _DatabaseInfoXml;                          // 连接信息XML节点
    //    private System.Windows.Forms.PictureBox _PictureBox;           //图片显示框
    //    DevComponents.AdvTree.AdvTree _LayerTree;                     //图层控制树图
    //    private List<string> _ListUserPrivilegeID;                   //用户权限编号
    ...
    //    public AppOracleSpatialRef()
    //    {
    //    }
    //    public AppOracleSpatialRef(Form pForm, Control ControlContainer, XmlDocument SystemXml, XmlDocument DataTreeXml, XmlDocument DatabaseInfoXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _MainForm = pForm;
    //        _ControlContainer = ControlContainer;
    ...
    //        _ImageResPath = ImageResPath;
    //    }
    //    #region IappOracleSpatialRef  成员

    //    public UserControl MainUserControl
    //    {
    //        get { return this._MainUserControl; }
    //        set { this._MainUserControl = value; }
    //    }



    //    public DevComponents.AdvTree.AdvTree OraProjectTree
    //    {
    //        get { return this._OraProjectTree; }
    //        set { this._OraProjectTree = value; }
    //    }

    //    public DevComponents.AdvTree.AdvTree LayerTree
    //    {
    //        get
    //        {
    //            return _LayerTree;
    ...
    //    public XmlDocument DBXmlDocument
    //    {
    //        get { return this._DBXmlDocument; }
    //        set { this._DBXmlDocument = value; }
    //    }

    //    public Thread CurrentThread
    //    {
    //        get { return this._CurrentThread; }
    ...
    /// <summary>
    /// 高程数据库管理子系统接口类实现 陈亚飞添加  20100929
    /// </summary>
    //public class AppDBContour : IAppDBContourRef, IAppFormRef
    //{
    //    private Form _MainForm;                                        // 窗体
    //    private UserControl _MainUserControl;                         //控件UserControl
    //    private Control _StatusStrip;                                 // 状态栏
    ...
    //    public AppDBContour(Form pForm, Control ControlContainer, XmlDocument SystemXml, XmlDocument DataTreeXml, XmlDocument DatabaseInfoXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _MainForm = pForm;
    //        _ControlContainer = ControlContainer;
    ...
    /// 高程数据库管理子系统接口类实现 陈亚飞添加  20100929
    /// </summary>
    //public class AppDBImage : IAppDBImageRef, IAppFormRef
    //{
    //    private Form _MainForm;                                        // 窗体
    //    private UserControl _MainUserControl;                         //控件UserControl
    //    private Control _StatusStrip;                                 // 状态栏
    ...
    //    public AppDBImage(Form pForm, Control ControlContainer, XmlDocument SystemXml, XmlDocument DataTreeXml, XmlDocument DatabaseInfoXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _MainForm = pForm;
    //        _ControlContainer = ControlContainer;
    ...
    /// 高程数据库管理子系统接口类实现 陈亚飞添加  20100929
    /// </summary>
    //public class AppDBAddress : IAppDBAddressRef, IAppFormRef
    //{
    //    private Form _MainForm;                                        // 窗体
    //    private UserControl _MainUserControl;                         //控件UserControl
    //    private Control _StatusStrip;                                 // 状态栏
    ...
    //    public AppDBAddress(Form pForm, Control ControlContainer, XmlDocument SystemXml, XmlDocument DataTreeXml, XmlDocument DatabaseInfoXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _MainForm = pForm;
    //        _ControlContainer = ControlContainer;
    ...
    /// 高程数据库管理子系统接口类实现 陈亚飞添加  20100929
    /// </summary>
    //public class AppDBEntity : IAppDBEntityRef, IAppFormRef
    //{
    //    private Form _MainForm;                                        // 窗体
    //    private UserControl _MainUserControl;                         //控件UserControl
    //    private Control _StatusStrip;                                 // 状态栏
    ...
    //    public AppDBEntity(Form pForm, Control ControlContainer, XmlDocument SystemXml, XmlDocument DataTreeXml, XmlDocument DatabaseInfoXml, Plugin.Parse.PluginCollection ColParsePlugin, string ImageResPath)
    //    {
    //        //沿袭AppFormRef 参数
    //        _MainForm = pForm;
    //        _ControlContainer = ControlContainer;
