...
{
    public class CommandEachForCumulationStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandEachForCumulationStatistics()
        {
            base._Name = "GeoStatistics.CommandEachForCumulationStatistics";
            base._Caption = "各类森林、林木面积蓄积统计";
            base._Tooltip = "各类森林、林木面积蓄积统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "各类森林、林木面积蓄积统计";
        ...
        public override void OnClick()
        {
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog("八类统计--林地及森林面积规划");  //ygc 2012-9-14 写日志
            }
        }
