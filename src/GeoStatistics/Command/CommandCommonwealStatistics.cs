...
{
    public class CommandCommonwealStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandCommonwealStatistics()
        {
            base._Name = "GeoStatistics.CommandCommonwealStatistics";
            base._Caption = "生态公益林（地）统计";
            base._Tooltip = "生态公益林（地）统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "生态公益林（地）统计";
