...
{
    public class CommandSelAreaStatistics : Plugin.Interface.CommandRefBase
    {
        ...
        public CommandSelAreaStatistics()
        {
            base._Name = "GeoStatistics.CommandSelAreaStatistics";
            base._Caption = "要素范围统计";
            base._Tooltip = "要素范围统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled =false;
            base._Message = "要素范围统计";

            m_pCommand = new GeoStatistics.Command.ToolSelAreaStatistics();
        }
