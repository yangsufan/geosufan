...
{
    public class CommandZLDJXX : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandZLDJXX()
        {
            base._Name = "GeoStatistics.CommandZLDJXX";
            base._Caption = "质量等级信息";
            base._Tooltip = "质量等级信息";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "质量等级信息";
