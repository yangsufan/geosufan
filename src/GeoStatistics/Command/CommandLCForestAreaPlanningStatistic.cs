...
{
    public class CommandLCForestAreaPlanningStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestAreaPlanningStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestAreaPlanningStatistic";
            base._Caption = "林地及森林面积规划";
            base._Tooltip = "林地及森林面积规划";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "林地及森林面积规划";
