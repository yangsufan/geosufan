...
{
    public class CommandForestQualityStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestQualityStatistic()
        {
            base._Name = "GeoStatistics.CommandForestQualityStatistic";
