...
{
    public class CommandUserfullStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandUserfullStatistics()
        {
            base._Name = "GeoStatistics.CommandUserfullStatistics";
            base._Caption = "用材林面积蓄积按龄级统计";
            base._Tooltip = "用材林面积蓄积按龄级统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "用材林面积蓄积按龄级统计";
