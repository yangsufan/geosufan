...
{
    public class CommandPopulationStatistics : Plugin.Interface.CommandRefBase
    {
        ...
        public CommandPopulationStatistics()
        {
            base._Name = "GeoStatistics.CommandPopulationStatistics";
            base._Caption = "人口分布统计";
            base._Tooltip = "人口分布统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled =false;
            base._Message = "人口分布统计";
