...
{
    public class CommandForestProtectGradeStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestProtectGradeStatistic()
        {
            base._Name = "GeoStatistics.CommandForestProtectGradeStatistic";
            base._Caption = "林地保护等级";
            base._Tooltip = "林地保护等级";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "林地保护等级";
        ...
        public override void OnClick()
        {
            ...
            string playerTreePath = Application.StartupPath + "\\..\\res\\xml\\展示图层树15.xml";
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog("八类统计--林地保护等级"); //ygc 2012-9-14 写日志
            }
        }
