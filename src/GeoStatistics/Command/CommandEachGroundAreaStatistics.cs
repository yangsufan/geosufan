...
{
    public class CommandEachGroundAreaStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandEachGroundAreaStatistics()
        {
            base._Name = "GeoStatistics.CommandEachGroundAreaStatistics";
            base._Caption = "各类土地面积统计";
            base._Tooltip = "各类土地面积统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "各类土地面积统计";
