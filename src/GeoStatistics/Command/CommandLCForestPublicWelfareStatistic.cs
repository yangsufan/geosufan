...
{
    public class CommandLCForestPublicWelfareStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestPublicWelfareStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestPublicWelfareStatistic";
