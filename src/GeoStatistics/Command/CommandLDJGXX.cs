...
{
    public class CommandLDJGXX : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLDJGXX()
        {
            base._Name = "GeoStatistics.CommandLDJGXX";
            base._Caption = "林地结构信息";
            base._Tooltip = "林地结构信息";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "林地结构信息";
