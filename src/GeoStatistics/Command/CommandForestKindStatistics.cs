...
{
    public class CommandForestKindStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestKindStatistics()
        {
            base._Name = "GeoStatistics.CommandForestKindStatistics";
            base._Caption = "林种统计";
            base._Tooltip = "林种统计";
            base._Checked = false;
            base._Visible = true;
