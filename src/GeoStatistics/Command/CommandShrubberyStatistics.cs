...
{
    public class CommandShrubberyStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandShrubberyStatistics()
        {
            base._Name = "GeoStatistics.CommandShrubberyStatistics";
            base._Caption = "灌木林统计";
            base._Tooltip = "灌木林统计";
            base._Checked = false;
            base._Visible = true;
