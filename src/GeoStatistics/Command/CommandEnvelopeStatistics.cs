...
{
    public class CommandEnvelopeStatistics : Plugin.Interface.CommandRefBase
    {
        ...
        public CommandEnvelopeStatistics()
        {
            base._Name = "GeoStatistics.CommandEnvelopeStatistics";
            base._Caption = "矩形范围统计";
            base._Tooltip = "矩形范围统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled =false;
            base._Message = "矩形范围统计";

            m_pCommand = new GeoStatistics.Command.ToolEvnelopeExport();
        }
