...
{
    public class CommandArborAreaStatistics : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandArborAreaStatistics()
        {
            base._Name = "GeoStatistics.CommandArborAreaStatistics";
            base._Caption = "乔木林面积蓄积按龄组统计";
            base._Tooltip = "乔木林面积蓄积按龄组统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "乔木林面积蓄积按龄组统计";
