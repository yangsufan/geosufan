...
{
    public class CommandForestAreaPlanningStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestAreaPlanningStatistic()
        {
            base._Name = "GeoStatistics.CommandForestAreaPlanningStatistic";
