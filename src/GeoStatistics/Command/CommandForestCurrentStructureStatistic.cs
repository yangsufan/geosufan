...
{
    public class CommandForestCurrentStructureStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestCurrentStructureStatistic()
        {
            base._Name = "GeoStatistics.CommandForestCurrentStructureStatistic";
