...
{
    public class CommandForestCurrentStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestCurrentStatistic()
        {
            base._Name = "GeoStatistics.CommandForestCurrentStatistic";
            base._Caption = "林地现状";
            base._Tooltip = "林地现状";
            base._Checked = false;
            base._Visible = true;
