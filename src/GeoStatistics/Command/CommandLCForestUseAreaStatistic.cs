...
{
    public class CommandLCForestUseAreaStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestUseAreaStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestUseAreaStatistic";
            base._Caption = "林地利用方向规划面积";
            base._Tooltip = "林地利用方向规划面积";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "林地利用方向规划面积";
        ...
        public override void OnClick()
        {
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog("八类统计--林地利用方向规划面积");//ygc 2012-9-14 写日志
            }
        }
