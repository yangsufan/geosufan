...
{
    public class CommandGCLBXX : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandGCLBXX()
        {
            base._Name = "GeoStatistics.CommandGCLBXX";
            base._Caption = "工程类别信息";
            base._Tooltip = "工程类别信息";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "工程类别信息";
