...
{
    public class CommandForestUseAreaStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestUseAreaStatistic()
        {
            base._Name = "GeoStatistics.CommandForestUseAreaStatistic";
