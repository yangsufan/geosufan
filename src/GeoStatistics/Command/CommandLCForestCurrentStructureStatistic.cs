...
{
    public class CommandLCForestCurrentStructureStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestCurrentStructureStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestCurrentStructureStatistic";
            base._Caption = "林地结构现状";
            base._Tooltip = "林地结构现状";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "林地结构现状";
        ...
        public override void OnClick()
        {
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog("八类统计--林地结构现状统计"); //ygc 2012-9-14 写日志
            }
