...
{
    public class CommandLCForestProtectGradeStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestProtectGradeStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestProtectGradeStatistic";
