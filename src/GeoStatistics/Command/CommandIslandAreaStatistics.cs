...
{
    public class CommandIslandAreaStatistics : Plugin.Interface.CommandRefBase
    {
        ...
        public CommandIslandAreaStatistics()
        {
            base._Name = "GeoStatistics.CommandIslandAreaStatistics";
            base._Caption = "海岛礁面积统计";
            base._Tooltip = "海岛礁面积统计";
            base._Checked = false;
            base._Visible = true;
            base._Enabled =false;
            base._Message = "海岛礁面积统计";
