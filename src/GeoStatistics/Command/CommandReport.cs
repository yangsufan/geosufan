...
{
    public class CommandReport : Plugin.Interface.CommandRefBase
    {
        ...
        {
            base._Name = "GeoStatistics.CommandReport";
            base._Caption = "底表统计";
            base._Tooltip = "底表统计";
            base._Checked = false;
            base._Visible = true;
        ...
        public override void OnClick()
        {
            ...
            vProgress.MaxValue = 12;
            vProgress.ProgresssValue = 0;
            vProgress.Step = 1;
            vProgress.ShowProgress();
            vProgress.SetProgress("正在进行各类信息底表统计");
            ModCommon.DoReportStatistic(_LinBanFeatureClass, "xbmj","xjl",vProgress);
            vProgress.Close();
