...
{
    public class CommandLCForestLandProtectionLevelStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandLCForestLandProtectionLevelStatistic()
        {
            base._Name = "GeoStatistics.CommandLCForestLandProtectionLevelStatistic";
            base._Caption = "国家级公益林地分保护等级现状";
            base._Tooltip = "国家级公益林地分保护等级现状";
            base._Checked = false;
            base._Visible = true;
            base._Enabled = false;
            base._Message = "国家级公益林地分保护等级现状";
        ...
        public override void OnClick()
        {
            ...
            if (this.WriteLog)
            {
                Plugin.LogTable.Writelog("八类统计--国家级公益林地分保护等级现状"); //ygc 2012-9-14 写日志
            }
        }
