...
{
    public class CommandForestLandProtectionLevelStatistic : Plugin.Interface.CommandRefBase
    {
        private Plugin.Application.IAppGisUpdateRef _AppHk;
        private Plugin.Application.IAppFormRef m_pAppForm;

        public CommandForestLandProtectionLevelStatistic()
        {
            base._Name = "GeoStatistics.CommandForestLandProtectionLevelStatistic";
